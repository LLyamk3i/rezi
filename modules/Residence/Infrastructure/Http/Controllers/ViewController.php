    ...
    public function store(Request $request): JsonResponse
    {
        ...
        if (
            ...
            throw ValidationException::withMessages(messages: [
                'residence_id' => [trans(key: 'residence::messages.view.add.error', replace: ['id' => $residence])],
            ]);
        }
        ...
        return response()->json(
            ...
            data: [
                'success' => true,
                'message' => trans(key: 'residence::messages.view.add.success', replace: ['id' => $residence]),
            ]
        );
    }
}
